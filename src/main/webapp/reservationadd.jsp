    ...
    <div class="container">
        <div class="form-card">
            ...
            <% if(request.getParameter("success") != null) { %>
                <div class="message success">Reservation added successfully!</div>
            <% } %>
            <% if(request.getParameter("error") != null) { %>
                <div class="message error">Error adding reservation. Please try again.</div>
            <% } %>
            ...
            <form action="AddReservationServlet" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="totalAmount" step="0.01" required placeholder="Enter total amount">
                </div>
